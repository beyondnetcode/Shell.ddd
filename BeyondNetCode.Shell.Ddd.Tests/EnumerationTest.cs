namespace BeyondNetCode.Shell.Ddd.Test
{
    [TestClass]
    public class EnumerationTest
    {
        ...
        public void Parse_ShouldThrowExceptionWithCorrectMessage()
        {
            ...
            {
                Assert.AreEqual("'3' is not a valid value in BeyondNetCode.Shell.Ddd.Test.Entities.SampleEntityStatus", ex.Message);
            }
        }
        ...
        public void Parse_ShouldThrowExceptionWithCorrectMessage2()
        {
            ...
            {
                Assert.AreEqual("'Third' is not a valid display name in BeyondNetCode.Shell.Ddd.Test.Entities.SampleEntityStatus", ex.Message);
            }
        }
